...
export const surfaces: Surface[] = [
	...
	{
		title: 'Control plane',
		body: 'Start workflows, send signals, run queries — plus a kill-worker chaos button to prove durable recovery.',
		icon: [
			path('M21 4H14'),
			path('M10 4H3'),
			path('M21 12H12'),
...
export const concepts: Concept[] = [
	{
		...
		body: 'The payment charge runs as an activity with a retry policy — transient failures back off and retry automatically.',
		icon: [
			path(
	...
	},
	{
		...
		body: 'A declined card is permanent — the activity throws a non-retryable failure that skips the retry policy, and the workflow cancels the order.',
		icon: [
			path(
	...
	{
		title: 'Signals',
		body: 'Restaurant acceptance, delivery completion, and cancellation all arrive as signals. The workflow blocks on condition() until they land.',
		icon: [
...
export const tour: TourStep[] = [
	...
	},
	{
		...
		body: 'The payment charge runs as an activity. Transient failures retry with exponential backoff — no retry loops to write.'
	},
	{
		n: 3,
	...
	},
	{
		...
		body: 'Send the delivery-completed signal. The workflow resumes from its final wait and finishes as delivered.'
	}
];
...
export const faqs: Faq[] = [
	...
	},
	{
		...
		a: 'Yes. Edit the workflow and activities in the Monaco editor. Saving hot-restarts the worker while the Temporal server keeps in-flight workflows alive — that’s the durability demo.'
	}
];
