	...
	<main>
			...
			<div class="sd-hero__grid">
				<div>
					...
					<p class="sd-hero__lede">
						Boots an ephemeral sandbox running a real Temporal dev server and a live worker. Edit
						the workflow, start a durable order, then kill the worker mid-flight and watch it resume
			...
			<div class="sd-band__inner sd-band__inner--narrow">
				...
				<div class="sd-diagram">
					...
					<div class="sd-anim sd-server">
						...
						<span class="sd-native-badge">State preserved</span>
					</div>
		...
		<section id="tour" class="sd-tour">
			<div class="sd-section-head">
				...
				<p class="sd-section-lede">
					The tour advances step-by-step as actual workflow events land — not on button clicks.
					Here's the path from your first order to durable recovery.
				</p>
			</div>
...
<style>
	...
	.sd-native-badge {
		...
		align-items: center;
		width: fit-content;
		border: 1px solid color-mix(in oklch, var(--cinder-success), transparent 55%);
		border-radius: var(--cinder-radius-full);
		background: color-mix(in oklch, var(--cinder-success), transparent 88%);
		color: var(--cinder-success);
		font-size: 0.75rem;
		font-weight: 650;
